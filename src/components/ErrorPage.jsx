...
import ErrorFlower from "../assets/flowers/lillies_transparent_1.png";
    ...
    return (
        <div className="hero bg-base-200 min-h-screen">
            <div className="hero-content flex-col lg:flex-row">
                <img src={ErrorFlower} alt="ErrorFlower" className="w-100 h-100 object-contain"/> 
            <div>
            <h1 className="text-5xl font-bold">Uh oh your garden has been overrun with pests (errors)! They've kicked you out.</h1>
            <div className="py-6">
