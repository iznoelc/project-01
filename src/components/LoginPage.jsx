...
function LoginPage(){
    ...
    const [msg, setMsg] = useState("Error signing in. Please try again.");
    ...
    const handleSubmit = (event) => {
        ...
        .catch((error) => {
            ...
            setMsg("Error signing in. Please try again!");
            errorNotify(msg);
    ...
    return(
        ...
        <div className="flex items-center justify-center gap-5">
            <p className="secondary-font">New around here? <a href="../signup" className="hover:text-primary q
            text-center">Sign Up</a></p>
        </div>
        </div>)}
        </>
    );
